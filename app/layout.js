...
export const metadata = {
  title: "Sevs Shop",
  description: "The Best Connections with the Best Products",
};
  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <i className="fa-brands fa-x-twitter text-slate-700 hover:text-slate-500 cursor-pointer text-2xl sm:text-3xl"></i>
        </Link>
        </footer>
        {/* div to access the modal */}
        <div id="portal"></div>
      </body>
    </html>
  );
